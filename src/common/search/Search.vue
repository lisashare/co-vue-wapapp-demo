<template>
    <div class="search page-top">
        ...
        <!-- 顶部搜索框 start-->
        <div class="search-header bc real-search line-bottom">
        ...
        <div class="cont" >
            ...
            <div class="title" v-if="showHistory">
                ...
                <div class="search-branch">
                    <ul>
                        <router-link :to="{name:'brandsearch',query:{name:item}}" tag="li" class="search-history ellipsis" v-for="(item,index) in searchHistory" :key="index">
...
export default {
  ...
  methods: {
    ...
    //     }
    //   }
    //    this.$http.post(this.baseurl + '/home/hotbrand', params).then(res => {
