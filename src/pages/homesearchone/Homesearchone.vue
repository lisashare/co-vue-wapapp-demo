    ...
    <div class="search page-top">
        ...
        <div class="cont" >
            ...
            <div class="title" v-if="showHistory">
                ...
                <div class="search-branch">
                    <ul>
                        <router-link :to="{name:'homesearchtwo',query:{name:item}}" tag="li" class="search-history ellipsis" v-for="(item,index) in searchHistory" :key="index">
...
export default {
  ...
  methods: {
    getListHotInfo () { // 获取热门信息
      let {params} = this
      this.$http.post(this.baseurl+'/home/hotlist', params).then(res => {
    ...
    //   } else {
      ...
      // 跳转
      this.$router.push({ name: 'homesearchtwo', query: { name: this.searchValue }})
      // 清空value值
      this.searchValue = ''
      // }
    },
